            ...
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-center relative">
                    {currentStep === 2 && (
                        <button
                            onClick={handleBack}
                            className="absolute left-0 flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-700 hover:text-primary transition-colors"
                        >
                            ...
                            return (
                                <div key={step.id} className="flex items-center">
                                    <div className="flex flex-col items-center relative">
                                        ...
                                        <span
                                            className={cn(
                                                "absolute top-10 text-xs font-bold whitespace-nowrap",
